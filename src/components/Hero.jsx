  ...
  return (
    <>
      <div className="flex h-screen">
        <div className="md:w-1/2 flex z-10">
          <div className="md:pl-40 md:p-0 p-4 flex items-center">
            <div className="md:pt-20 pt-16">
              <h1 className="text-4xl md:text-5xl font-bold md:py-4 w-1/2 md:w-full">
                Discover Culinary{" "}
                <span className="text-orange-400">Delights</span>
              </h1>
              <p className="text-lg md:text-xl text-gray-500 py-5 w-1/2 md:w-full">
              ...
              <div className="md:flex md:space-x-4 space-y-2 md:space-y-0 py-10 text-center text-gray-600">
                <div className="bg-gray-100 flex md:flex-col items-center w-full shadow-lg rounded-lg p-4 md:w-28 cursor-pointer hover:-translate-y-1 transition duration-300">
                  <img src={Find} alt="Find" className="w-8 md:w-14 mr-2 md:mx-auto" />
                  <div className="pt-0 md:pt-2">Find Recipe</div>
                </div>
                <div className="bg-white flex md:flex-col items-center w-full shadow-lg rounded-lg p-4 md:w-28 cursor-pointer hover:-translate-y-1 transition duration-300">
